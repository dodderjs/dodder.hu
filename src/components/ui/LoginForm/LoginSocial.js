...
const LoginSocial = (props) => {
	const { googleUrl, facebookUrl } = props;
	...
	return (
		<div className="login-social">
			...
			<div className="login-social--buttons">
				{googleUrl &&
					<a href={googleUrl} className="button google-login button-login">
				...
				{facebookUrl &&
					<a href={facebookUrl}  className="button facebook-login button-login">
						<span className="button-icon">
